...
export default function GlobalError({ error, reset }: GlobalErrorProps) {
  ...
  return (
    <html lang="en">
      <body className="flex min-h-dvh flex-col items-center justify-center gap-6 bg-background px-6 py-12 text-center text-foreground">
        <div className="rounded-3xl border border-white/60 bg-white/85 px-6 py-8 shadow-[0_20px_50px_rgba(173,216,255,0.35)] backdrop-blur">
          ...
          <p className="mt-3 max-w-md text-sm text-muted-foreground sm:text-base">
            We hit an unexpected snag. Try again or head back home to start a
            fresh puzzle.
          </p>
