  ...
  return (
    <div>
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetContent
          side="bottom"
          className="max-h-[85dvh] w-full rounded-t-3xl border-t border-white/70 bg-white/95 px-0 pb-[max(1rem,env(safe-area-inset-bottom,34px))] pt-0 shadow-[0_-20px_45px_rgba(20,184,166,0.12)]"
        >
